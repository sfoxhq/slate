...
* **PubliC API** — Connect to SFOX Rest API. Sfox()
                 — Raw Orderbook
                 — Live Orderbook
                 — Best Buy Price
                 — Best Sell Price
                 
* **Private API** — Connect to Private API. PrivateSfox('#Enter API Key') 
                  — Balance
                  — getOrderStatus
                  — getTradeHistory
                  — getActiveOrders
...
* **Strategy** — Connect to Public and Private API. Strategy('#Enter API Key') 
